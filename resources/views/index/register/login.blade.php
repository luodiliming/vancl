...
<head>
    <meta charset="UTF-8">
    <title></title>
    <link rel="stylesheet" type="text/css" href="/Css/denglu/denglu.css" />
    <link rel="stylesheet" type="text/css" href="/Css/denglu/denglu1.css" />
    <link rel="stylesheet" type="text/css" href="/Css/denglu/denglu2.css" />
    <link href="/node_modules/hdjs/css/bootstrap.min.css" rel="stylesheet">
    <script src="/js/denglu/denglu.js" type="text/javascript"></script>
    <script src="/js/denglu/denglu1.js" type="text/javascript"></script>
    <script src="/js/denglu/denglu2.js" type="text/javascript"></script>
    <script src="/js/denglu/denglu3.js" type="text/javascript"></script>
...
<div class="wrapper">
    ...
    <div class="login">
        ...
        <div id="shows">
            ...
            <form action="/index/loginin"  method="post"  >
                ...
                <div class="user_infor" style="display: block;">
                    ...
                    @endif
                    {{--来到登录页面！处理with()方法！因为error存在了 session 里面。我们在模板中找一个地方去写一个@if(session(‘error’))--}}
                        {{--里面在写{{session(‘error’)}}      @endif  就可以做判断显示了！--}}
